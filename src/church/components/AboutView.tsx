...
export default function AboutView() {
  ...
  const [worshipBranch, setWorshipBranch] = useState<'banghwa' | 'unyang'>('unyang'); // 기본 운양예배당(김포)
          ...
          <div style={{ display: 'flex', gap: '40px', alignItems: 'flex-start', marginBottom: '60px' }} className="about-intro">
            ...
            <div>
              ...
              <div style={{ padding: '15px', background: 'var(--church-beige)', borderRadius: '8px', borderLeft: '4px solid var(--church-gold)' }}>
                <span style={{ fontWeight: 'bold', color: 'var(--church-navy)' }}>💡 기존 사이트 안내 링크</span><br />
                <span style={{ fontSize: '0.9rem', color: 'var(--church-text-muted)' }}>
                  기존에 작성된 목사님 인사말 원본 이미지는 아래 주소에서도 확인하실 수 있습니다.<br />
                  <a href="http://www.durannochurch.com/img/front/intro/ministerWord.jpg" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--church-gold)', textDecoration: 'underline' }}>[담임목사 인사말 이미지 보기]</a> | 
                  <a href="http://www.durannochurch.com/img/front/intro/minister.jpg" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--church-gold)', textDecoration: 'underline', marginLeft: '8px' }}>[담임목사 약력 보기]</a>
                </span>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <div>
            ...
            <div className="church-card" style={{
              ...
              {worshipBranch === 'banghwa' 
                ? '지도 영역: 서울 강서구 금낭화로 52 (구 방화동 594-1)' 
                : '지도 영역: 경기도 김포시 김포한강4로 123 (운양동)'}
            </div>
            {worshipBranch === 'banghwa' ? (
